...
export default function Home() {
  ...
  const occasions = [
    { id: 'oc-wedding', t: 'Wedding', d: 'The day two families became one — every glance, every vow, remembered forever.', ar: 'aspect-[4/5]', p: 'luxury wedding · golden hour' },
    { id: 'oc-engagement', t: 'Engagement', d: 'The quiet, trembling "yes" that started an entire lifetime together.', ar: 'aspect-[1/1]', p: 'engagement · ring · joy' },
    { id: 'oc-baby', t: 'Baby', d: 'First breaths, first cries, first everything — held forever in light.', ar: 'aspect-[4/5]', p: 'newborn baby · parents' },
    { id: 'oc-birthday', t: 'Birthday', d: 'Another candle, another year of being loved out loud.', ar: 'aspect-[3/4]', p: 'birthday celebration' },
    { id: 'oc-anniversary', t: 'Anniversary', d: 'A love story that is still, beautifully, being written.', ar: 'aspect-[4/5]', p: 'anniversary couple' },
    { id: 'oc-reunion', t: 'Family Reunion', d: 'Everyone, together, under one roof again — laughter in every corner.', ar: 'aspect-[1/1]', p: 'family reunion gathering' },
    { id: 'oc-graduation', t: 'Graduation', d: 'Years of quiet effort, finally worn with pride.', ar: 'aspect-[3/4]', p: 'graduation · cap & gown' },
    ...
    { id: 'oc-festivals', t: 'Festivals', d: 'Traditions passed gently from one generation to the next.', ar: 'aspect-[1/1]', p: 'festival · lights · family' },
    { id: 'oc-corporate', t: 'Corporate', d: 'Milestones worth far more than a memo.', ar: 'aspect-[3/4]', p: 'corporate milestone event' },
    { id: 'oc-achievements', t: 'Achievements', d: 'The rare, hard-won moments that deserve applause.', ar: 'aspect-[4/5]', p: 'achievement · award' },
    { id: 'oc-memorial', t: 'Memorial', d: 'A tender tribute that keeps a loved one close.', ar: 'aspect-[1/1]', p: 'memorial · legacy portrait' },
    { id: 'oc-everyday', t: 'Everyday Moments', d: 'The small, ordinary magic of simply being a family.', ar: 'aspect-[3/4]', p: 'candid family at home' }
  ];
      ...
      <main className="relative flex-1">
          ...
          <div className="max-w-[1320px] mx-auto px-6 md:px-10 pt-[140px] pb-[80px] grid grid-cols-1 lg:grid-cols-2 gap-14 items-center w-full relative z-10">
            ...
            <div className="relative h-[76vh] min-h-[520px] w-full">
              ...
              <div className="absolute inset-0 rounded-[200px_200px_24px_24px] overflow-hidden shadow-[0_40px_90px_-30px_rgba(30,27,24,0.5)]">
                <ImageSlot id="hero-main" shape="rect" placeholder="Hands holding an old family photograph · golden hour" />
              ...
              <div className="absolute bottom-[8%] left-[-6%] w-[180px] bg-bg-cream p-3 rounded-2xl shadow-[0_24px_50px_-20px_rgba(30,27,24,0.4)] -rotate-5 animate-float-y">
                <div className="relative w-full h-[120px] rounded-lg overflow-hidden">
                  <ImageSlot id="hero-polaroid" shape="rect" placeholder="vintage family snapshot" />
                </div>
                ...
                <Reveal key={o.id} delay={0.05 * (i % 3)} className="break-inside-avoid mb-[26px] bg-white rounded-2xl overflow-hidden shadow-[0_18px_40px_-26px_rgba(110,86,68,0.5)] cursor-pointer group hover:translate-y-[-6px] hover:shadow-[0_30px_60px_-28px_rgba(110,86,68,0.55)] transition-all duration-500">
                  <div className={`relative ${o.ar} overflow-hidden`}>
                    <div className="absolute inset-0 transition-transform duration-700 ease-out group-hover:scale-106">
                      <ImageSlot id={o.id} shape="rect" placeholder={o.p} />
                    </div>
          ...
          <div className="max-w-[1320px] mx-auto px-6 md:px-10 relative z-20">
            ...
            <Reveal className="relative rounded-3xl overflow-hidden shadow-[0_40px_90px_-34px_rgba(110,86,68,0.55)] mb-11">
              <div className="relative aspect-[16/8]">
                <ImageSlot id="fb-hero" shape="rect" placeholder="First birthday · cake cutting · confetti · golden hour" />
                <div className="absolute inset-0 bg-gradient-to-t from-bg-dark/50 to-transparent pointer-events-none"></div>
              </div>
              <button 
                onClick={() => openVideo("Aarav Turns One — Preview", "https://www.w3schools.com/html/mov_bbb.mp4")}
              ...
              <div className="absolute left-[26px] bottom-[24px] text-bg-cream">
                <p className="font-cormorant italic text-[22px]">Aarav turns one — a cinematic preview</p>
        ...
        <section className="relative min-h-[80vh] flex items-center overflow-hidden py-20">
          <div className="absolute inset-0">
            <ImageSlot id="cta-bg" shape="rect" placeholder="Sunset · family laughing · children running · cinematic" />
          </div>
