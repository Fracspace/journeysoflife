...
import heroImg from "../../../public/assets/how-it-works/realPeople.png";

import uploadImg from "../../../public/assets/how-it-works/uploadMemories.png";
import storyImg from "../../../public/assets/how-it-works/story.png";
import creativeImg from "../../../public/assets/how-it-works/creativeEditing.png";
import reviewImg from "../../../public/assets/how-it-works/review.png";
import refineImg from "../../../public/assets/how-it-works/refinement.png";

import handcraftedImg from "../../../public/assets/how-it-works/handCrafted.png";
import realPeopleImg from "../../../public/assets/how-it-works/realPeople.png";
import privateImg from "../../../public/assets/how-it-works/privateAndSecure.png";
import legacyImg from "../../../public/assets/how-it-works/legacy.png";

import grpFestImg from "../../../public/assets/how-it-works/festiveGrp.png";
  ...
  const inclusions = [
    {
      ...
      desc: "We revive faded, torn and creased photographs to their former glory."
    },
    {
      num: "02",
      title: "Storytelling",
      desc: "A narrative written around your family, in your own words."
    },
    {
      num: "03",
      title: "Colour Grading",
      desc: "Warm, filmic colour that makes every scene feel timeless."
    },
    {
      num: "04",
      title: "Motion & Animation",
      desc: "Gentle movement that brings still photographs to life."
    },
    {
      num: "05",
      title: "Original Music",
      desc: "Scored to match the emotion of your story."
    },
    {
      num: "06",
      title: "Cinematic Editing",
      desc: "Paced and cut by hand for maximum feeling."
    },
    {
      num: "07",
      title: "Premium Delivery",
      desc: "Delivered in elegant packaging, ready to gift."
    },
    {
      num: "08",
      title: "Unlimited Care",
      desc: "We stay with you until every moment feels right."
    }
  ];
          ...
          <div className="max-w-[1320px] mx-auto px-6 md:px-10 grid grid-cols-1 lg:grid-cols-2 gap-[60px] items-center relative z-10">
            <div className="max-w-[560px]">
              ...
              <Reveal delay={0.2}>
                <p className="text-[16.5px] leading-relaxed text-text-gray max-w-[460px]">
                  From a shoebox of photographs to a film that moves a room to
                  tears — here is the quiet, careful craft behind every Journeys
                  of Life story.
                </p>
              </Reveal>
            </div>
            ...
            <Reveal className="relative aspect-[5/4] rounded-[200px_24px_200px_24px] overflow-hidden shadow-[0_40px_90px_-34px_rgba(110,86,68,0.55)]">
              <ImageSlot
                ...
                id="how-hero"
                shape="rect"
                placeholder="Editor colour-grading a family film · warm studio"
              />
            ...
            <div className="relative">
              ...
              {steps.map((step, i) => (
                ...
                >
                  {/* LEFT COLUMN */}
                  <div
                    className={`pl-4 md:pl-0 ${step.alignLeft ? "md:text-right md:pr-4.5 order-2 md:order-1" : "hidden md:block order-2 md:order-1"}`}
                  >
                    {step.alignLeft ? (
                      <>
                        <h3 className="font-cormorant font-semibold text-[24px] md:text-[27px] mb-2 text-text-dark">
                          {step.title}
                        </h3>
                        <p className="text-[14.5px] leading-relaxed text-text-gray">
                          {step.desc}
                        </p>
                      </>
                    ) : (
                  ...
                  {/* RIGHT COLUMN */}
                  <div
                    className={`pl-4 md:pl-0 ${step.alignLeft ? "hidden md:block order-3" : "md:pl-4.5 order-2 md:order-3"}`}
                  >
                    {!step.alignLeft ? (
                      <>
                        <h3 className="font-cormorant font-semibold text-[24px] md:text-[27px] mb-2 text-text-dark">
              ...
              <Reveal className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-14 items-center">
                <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-[0_28px_60px_-30px_rgba(110,86,68,0.55)] md:order-1">
                  <ImageSlot
                    ...
                    id="why-1"
                    shape="rect"
                    placeholder="editor at work · warm studio"
                  />
                </div>
                <div className="md:order-2">
                  <h3 className="font-cormorant font-semibold text-[26px] md:text-[38px] leading-tight mb-3.5 text-text-dark">
                    Handcrafted, never automated
                  </h3>
                  <p className="text-[15.5px] leading-relaxed text-[#7C7267] max-w-[440px]">
                    Every frame is shaped by a human editor who cares about your
                    family as much as you do. No templates, no shortcuts.
                  </p>
                </div>
              </Reveal>
              ...
              <Reveal className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-14 items-center">
                <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-[0_28px_60px_-30px_rgba(110,86,68,0.55)] md:order-2">
                  <ImageSlot
                    ...
                    id="why-2"
                    shape="rect"
                    placeholder="team reviewing footage"
                  />
                </div>
                <div className="md:order-1">
                  ...
                  <p className="text-[15.5px] leading-relaxed text-[#7C7267] max-w-[440px]">
                    Your memories are handled by storytellers, not algorithms.
                    The warmth you feel is genuinely, entirely human.
                  </p>
                </div>
              </Reveal>
              ...
              <Reveal className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-14 items-center">
                <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-[0_28px_60px_-30px_rgba(110,86,68,0.55)] md:order-1">
                  <ImageSlot
                    ...
                    id="why-3"
                    shape="rect"
                    placeholder="hands holding photographs"
                  />
                </div>
                <div className="md:order-2">
                  <h3 className="font-cormorant font-semibold text-[26px] md:text-[38px] leading-tight mb-3.5 text-text-dark">
                  ...
                  <p className="text-[15.5px] leading-relaxed text-[#7C7267] max-w-[440px]">
                    Your photographs and stories stay yours. Encrypted,
                    confidential, and never shared without your word.
                  </p>
                </div>
              </Reveal>
              ...
              <Reveal className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-14 items-center">
                <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-[0_28px_60px_-30px_rgba(110,86,68,0.55)] md:order-2">
                  <ImageSlot
                    ...
                    id="why-4"
                    shape="rect"
                    placeholder="grandparents & grandchildren"
                  />
                </div>
                <div className="md:order-1">
                  <h3 className="font-cormorant font-semibold text-[26px] md:text-[38px] leading-tight mb-3.5 text-text-dark">
                  ...
                  <p className="text-[15.5px] leading-relaxed text-[#7C7267] max-w-[440px]">
                    We make films to be handed down — archival quality that your
                    grandchildren will one day treasure.
                  </p>
                </div>
              </Reveal>
            </div>
              ...
              {inclusions.map((inc, i) => (
                ...
                >
                  <div className="w-12 h-12 rounded-xl bg-bg-cream border border-primary/30 grid place-items-center mb-[18px]">
                    <span className="font-cormorant text-primary text-xl font-bold">
                      {inc.num}
                    </span>
                  </div>
                  <h3 className="font-cormorant font-semibold text-[21px] mb-2 text-text-dark">
                    {inc.title}
                  </h3>
        ...
        <section className="relative min-h-[64vh] flex items-center overflow-hidden py-[100px]">
          <div className="absolute inset-0">
            <ImageSlot
              ...
              id="cta-band-bg"
              shape="rect"
              placeholder="Sunset · family together · cinematic"
            />
          </div>
          ...
          <div className="relative max-w-[1320px] mx-auto px-6 md:px-10 w-full z-10">
            <div className="max-w-[600px]">
              <Reveal>
                <p className="font-caveat text-[28px] text-primary-light mb-3">
